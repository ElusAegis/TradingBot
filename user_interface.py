...
class TradingSimulator(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        for F in (MainMenu, TwoPlayerPriceChart, PriceChartSettings,
                  PlayerVSBotPriceChart, PlayerVSBotPriceChartPriceChartSettings):
...
class MainMenu(tk.Frame):
    ...
    def init_ui(self):
        ...
        lbl.pack(side="top")
        # Set up buttons
        button1 = tk.Button(self, text="Two player Game",
                            command=lambda: self.controller.show_frame(PriceChartSettings),
                            bg = self.style.bt_color)

        button1.pack()

        button2 = tk.Button(self, text="Player vs Bot Game",
                            command=lambda: self.controller.show_frame(PlayerVSBotPriceChartPriceChartSettings),
                            bg = self.style.bt_color)
        button2.pack()
...
class PriceChartSettings(tk.Frame):
    ...
    def init_ui(self):
        ...
        bt_pr_chart = tk.Button(self, text="Live Price Chart",
                                command=lambda: self.controller.show_frame(TwoPlayerPriceChart, restart=True),
                                bg=self.style.bt_color)
...
class TwoPlayerPriceChart(tk.Frame):
...
class PlayerVSBotPriceChartPriceChartSettings(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.parent = parent
        self.controller = controller
    ...
    def init_ui(self):
        ...
        bt_pr_chart = tk.Button(self, text="Live Price Chart",
                                command=lambda: self.controller.show_frame(PlayerVSBotPriceChart, restart=True),
                                bg=self.style.bt_color)
        bt_pr_chart.grid(columnspan=2, column=3, row=13, pady=50)
...
class PlayerVSBotPriceChart(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.lbl_score1 = None
        self.lbl_score2 = None
        self.__lbl_stock_amount2 = None
        self.__lbl_money_amount2 = None
    ...
    def init_ui(self):
        ...
        self.__lbl_stock_amount2 = tk.Label(self, text="Stock amount: %.2f" % 0)
        self.__lbl_money_amount2 = tk.Label(self, text="Money amount: %.2f" % 0)
        self.__lbl_stock_amount2.grid(column=4, columnspan=2, row=7)
        self.__lbl_money_amount2.grid(column=4, columnspan=2, row=8)
    ...
    def update(self):
        data = self.game.update_data(self.chart_size.get())
        self.game.question(index=2)

        self.__lbl_stock_amount2.config(text="Stock amount: %.2f" % self.game.player2.stock_volume,
                                 fg="black" if self.game.player2.stock_volume >= 0 else "red")

        self.__lbl_money_amount2.config(text="Money amount: %.2f" % self.game.player2.balance,
                                 fg="black" if self.game.player2.balance >= 0 else "red")
    ...
    def start(self):
        self.game = GameLogic(player2=False,
                              stock_name=self.controller.get_setting("stock_name"),
                              game_mode=self.controller.get_setting("game_mode"),
                              file_path=self.controller.get_setting("file_path"),
                              safe=self.controller.get_setting("safe_mode"))
